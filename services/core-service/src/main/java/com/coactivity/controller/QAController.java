...
public interface QAController {
   ...
   */
  ResponseEntity<QuestionResponse> askQuestion(String token, @Valid QuestionRequest request);
   ...
   */
  ResponseEntity<AnswerResponse> answerQuestion(String token, @Valid AnswerRequest request);
   ...
   */
  ResponseEntity<QuestionWithAnswersResponse> getQuestionWithAnswers(@Positive Integer questionId);
}
