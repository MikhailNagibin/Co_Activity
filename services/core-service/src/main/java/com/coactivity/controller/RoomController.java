...
public interface RoomController {
   ...
   */
  ResponseEntity<RoomCreationResponse> createRoom(String token, @Valid RoomCreationRequest request);
   ...
   */
  ResponseEntity<BulletinBoardResponse> updateBulletinBoard(String token, @Positive Integer roomId,
   ...
   * @throws IllegalArgumentException if room doesn't exist or content is invalid
   */
  ResponseEntity<Void> deleteBulletinBoard(String token, @Positive Integer roomId);
   ...
   * @see RoomSort
   */
  ResponseEntity<List<RoomSummaryResponse>> getRooms(String token, @Valid RoomFilter filter,
      RoomSort sortBy);
   ...
   */
  ResponseEntity<RoomDetailedResponse> getRoomById(@Positive Integer roomId, String token);
   ...
   */
  ResponseEntity<Void> joinRoom(String token, @Positive Integer roomId);
   ...
   */
  ResponseEntity<Void> leaveRoom(String token, @Positive Integer roomId);
   ...
   */
  ResponseEntity<Void> deleteRoom(String token, @Positive Integer roomId);
   ...
   */
  ResponseEntity<List<RoomParticipantResponse>> getRoomParticipants(String token,
   ...
   */
  ResponseEntity<MembershipVerificationResponse> isUserInRoom(String token, @Positive Integer roomId,
